 ...
 */
public class CalGuessRatingImp21 extends CalGuessRating {
    ...
    protected void calAvgValue(List<Rating> list) {
        ...
        CalUserVector21.cal(list);
    }

    @Override
    protected void calUserSimilarity(int i, int j, List<Rating> list)  {
        Set<Integer> itemSet = CalUserVector21.calIncludeSet(i, j);
        double sum1 = 0, sum2 = 0, sum3 = 0, wij = 1.0;
        if (itemSet.size() != 0) {
            wij = CalUserVector21.calGap(i, j, itemSet);
        }
