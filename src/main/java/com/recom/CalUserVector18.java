...
public class CalUserVector18 {
    ...
    public static double calCal(long x, int line) {
        ...
        if (line == 2) {
            long A = 419; //calA(1500000, 6000000);
            long B = 1474;//calB(1500000, 6000000);
        ...
        if (line == 3) {
            long A = 983; //calA(5000000, 9000000);
            long B = 4145; //calB(5000000, 9000000);
        ...
        if (line == 4) {
            long A = 2987; //calA(8000000, maxValue);
