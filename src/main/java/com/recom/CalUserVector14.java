...
public class CalUserVector14 {
    ...
    public static double calCal(long x, int line) {
        ...
        if (line == 2) {
            ...
            long f1 = 150000000 / 3600 / 24;
            long f2 = 175000000 / 3600 / 24;
            if (x > a && x <= f1) {
                return calTmp(x, c, A);
            } else if (x > f1 && x <= f2) {
                return 1;
        ...
        if (line == 3) {
            ...
            long f1 = 350000000 / 3600 / 24;
            long f2 = 375000000 / 3600 / 24;
            if (x > a && x <= f1) {
                return calTmp(x, c, A);
            } else if (x > f1 && x <= f2) {
                return 1;
