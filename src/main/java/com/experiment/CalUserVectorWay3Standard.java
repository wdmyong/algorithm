 ...
 */
public class CalUserVectorWay3Standard {
        ...
        for (Map.Entry<Integer, Map<Integer, Long>> entry1 : timeMatrix.entrySet()) {
            for (Map.Entry<Integer, Long> entry2 : entry1.getValue().entrySet()) {
                if (entry2.getValue() <= c) {
                    sum += (c - entry2.getValue()) * (c - entry2.getValue());
                    k++;
                }
            }
        }
        ...
        for (Map.Entry<Integer, Map<Integer, Long>> entry1 : timeMatrix.entrySet()) {
            for (Map.Entry<Integer, Long> entry2 : entry1.getValue().entrySet()) {
                if (entry2.getValue() >= c && entry2.getValue() <= b) {
                    sum += (entry2.getValue() - c) * (entry2.getValue() - c);
                    k++;
                }
            }
        }
    ...
    public static double calCal(long x, int line) {
        ...
        if (line == 2) {
            long A = 250118; //calA(1500000, 6000000);
            long B = 472725;//calB(1500000, 6000000);
        ...
        if (line == 3) {
            long A = 4620162; //calA(5000000, 9000000);
            long B = 1858618; //calB(5000000, 9000000);
        ...
        if (line == 4) {
            long A = 65681949; //calA(8000000, maxValue);
